...
public class UrlValidatorTest extends TestCase {
   ...
   public static void myAssert2(boolean bool1, boolean bool2, String url){
      if(bool1 =! bool2)
         System.out.println("ERROR: " + url + " wasn't " + bool1);
   }
   ...
   public static void testManualTest() {
      ...
      myAssert(true, urlVal.isValid("http://www.google.com/"), "http://www.google.com/");
      myAssert(true, urlVal.isValid("https://www.google.com"), "https://www.google.com");
      myAssert(true, urlVal.isValid("ftp://255.255.255.255/test1/file"), "ftp://255.255.255.255/test1/file");
      myAssert(true, urlVal.isValid("http://www.google.com/index.html"), "http://www.google.com/index.html");
      myAssert(true, urlVal.isValid("http://www.google.com:80/test/index.html"), "http://www.google.com:80/test/index.html");
      ...
      // test URLs made from ResultPair Objects
      System.out.println("Testing URLs made from ResultPair Objects:");
      ...
      String goodString = goodScheme.item + goodAuthority.item + goodPort.item + goodPath.item + goodQuery.item;
      myAssert(true, urlVal.isValid(goodString), goodString.toString());
      ...
      String badString = badScheme.item + badAuthority.item + badPort.item + badPath.item;
      myAssert(false, urlVal.isValid(badString), badString.toString());

      System.out.println("Done testing ResultPair Objects");
   ...
   public static void testIsValid() {
      ...
      final String[] validSchemes = new String[] {"http://", "ftp://", "https://", ""};
      ...
      final String[] validPorts = new String[] {":80", ":8888", ":65555", ":0", ""};
